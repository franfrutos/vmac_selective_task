var jsPsychVirtualChinrest = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          /** The speed of the ball in the blindpsot test. */
          ball_speed: {
              type: jspsych.ParameterType.FLOAT,
              pretty_name: "Ball speed",
              default: 2,
          },
  ...
  class VirtualChinrestPlugin {
      ...
      trial(display_element, trial) {
          ...
          this.ball_speed = trial.ball_speed;
      ...
      `;
          ...
          const animateBall = () => {
              const dx = -this.ball_speed;
              const x = parseFloat(this.ball.style.left); // This is necessary for custom speed
